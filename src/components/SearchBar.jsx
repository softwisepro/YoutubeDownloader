        ...
        <div className='md:max-w-[800px] md:min-w-[700px] lg:max-w-[1000px] lg:min-w-[900px] p-12 rounded-3xl shadow-xl'>
            ...
            <form className='relative flex md:block flex-col gap-3' onSubmit={handleFormSubmit}>
                ...
                {isLoading ? (
                    <>
                        <button
                            className='py-4 md:absolute bg-gradient-to-r px-16 shadow-lg shadow-black/20 from-indigo-100 to-indigo-400  right-10 top-4 text-white font-medium rounded-2xl'
                        >
                            <div role="status">
